...
import com.watchvault.ui.common.SecondaryButton
            ...
            Column(verticalArrangement = Arrangement.spacedBy(Spacing.sm)) {
                ...
                Card(shape = RoundedCornerShape(Radius.card), modifier = Modifier.fillMaxWidth()) {
                    Column(modifier = Modifier.padding(Spacing.md), verticalArrangement = Arrangement.spacedBy(Spacing.sm)) {
                        ...
                        SecondaryButton(text = "Add from URL", onClick = onAddFromUrl, modifier = Modifier.fillMaxWidth())
                    }
                }
            }
            ...
            Column(verticalArrangement = Arrangement.spacedBy(Spacing.sm)) {
                ...
                Card(
                    ...
                    Column(modifier = Modifier.padding(Spacing.md), verticalArrangement = Arrangement.spacedBy(Spacing.sm)) {
                        ...
                        Text("Watch research", style = MaterialTheme.typography.bodyMedium)
                        Text(
